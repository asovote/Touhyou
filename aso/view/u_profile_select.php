...
//				$jid = $row['j_id'];
	      ...
	      echo'<div class="col-lg-3 col-sm-4 col-xs-6">
		  			<img class="thumbnail img-responsive" src="img/'.$mimg.'" width="600" height="350">
				</div><!--SQLで撮ってきた画像に差し替え-->';
	      echo'<div align="center" valign="bottom">
		  			<form action="update.php" method="POST" onClick="return submitChk();"><br>';       
	      //echo'<form action="update.php" method="POST" onClick="return submitChk();">';
	      echo'<div id="voteimg" align="center">
