...
function tmWrite(int)
{
 ...
 // location.href = "test3.php?&" + escape(document.timer.hun.value) +"="+ escape(document.timer.sec.value);
...
function Start(){
  location.href = "test4.php?&" + escape(document.timer.hun.value) +"="+ escape(document.timer.sec.value) + "="+ escape(0);
//	cntStart();
}

function Stop(){
  location.href = "test4.php?&" + escape(document.timer.hun.value) +"="+ escape(document.timer.sec.value) + "="+ escape(1);
//	cntStart();
}
